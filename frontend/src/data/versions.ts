...
export const CHANGELOG_DATA: VersionRecord[] = [
	{
		...
		notes: [
			...
			"Por algún motivo no había pensado antes en lo útil que me vendría un menú de depuración para equiparme cartas, manipular las victorias... Todas las pruebas las estaba haciendo a mano; no me he sentido más imbécil en mi vida. Al implementar este nuevo menú se me fue la pinza con las funciones que tendría y al final acabé creando un monstruo que no podía continuar desarrollando, así que tuve que simplificarlo bastante. Recordad, chavales: menos es más. Consejito de David.",
